...
author: "**Ahemd Bin Abdus Salam**, **Priscilla Ntiamoah**, **Abdul Saboor**"
subtitle: |
...
```{r npv-monoculture, echo=TRUE, fig.align='center', fig.width=7, fig.height=5, out.width='70%', fig.cap='**Figure 2**: Net Present Value Distribution (USD per acre) for Monoculture over 7 years'}
plot_distributions(
...
```{r npv-intercropping, echo=TRUE, fig.align='center', fig.width=7, fig.height=5, out.width='70%', fig.cap='**Figure 3**: Net Present Value Distribution (USD per acre) for Intercropping over 7 years'}
plot_distributions(
  mcSimulation_object = combined_simulation,
...
```{r npv-decision, echo=TRUE, fig.align='center', fig.width=7, fig.height=5, out.width='70%', fig.cap='**Figure 4**: Net Present Value Distribution (USD per acre) for Decision (Intercropping – Monoculture) over 7 years'}
plot_distributions(
  mcSimulation_object = combined_simulation,
  vars                = "NPV_Decision",
  method              = "boxplot_density",
...
```{r npv-overlay, echo=TRUE, fig.align='center', fig.width=7, fig.height=5, out.width='70%', fig.cap='**Figure 5**: Net Present Value Distributions (USD per acre) for Monoculture vs. Intercropping over 7 years'}
plot_distributions(
  mcSimulation_object = combined_simulation,
...
```{r annual-cashflow, echo=TRUE, fig.align='center', fig.width=7, fig.height=5, out.width='70%', fig.cap='**Figure 6**: Annual Profit (USD per acre) time series for Monoculture vs. Intercropping over 7 years'}
plot_cashflow(
  mcSimulation_object = combined_simulation,
...
```{r cumulative-cashflow, echo=TRUE, fig.align='center', fig.width=7, fig.height=5, out.width='70%', fig.cap='**Figure 7:** Cumulative Profit (USD per acre) time series for Monoculture vs. Intercropping over 7 years'}
plot_cashflow(
  mcSimulation_object = combined_simulation,
...
# 3. Check if any EVPI > 0
positive_evpi <- EVPI_results$EVPI > 0

if (!any(positive_evpi, na.rm = TRUE)) {
  cat("**Warning:** There are no variables with a positive EVPI. You probably do not need a plot for that.\n")
} else {
  # 4. Only if there *are* positive EVPI values, draw the plot
  plot_evpi(
...
```{r vip-analysis, echo=TRUE, fig.align='center', fig.width=7, fig.height=5, out.width='70%', fig.cap='**Figure 8**: Variable Importance in Projection (Top 15 variables — `r opt_comp` PLS components)'}
